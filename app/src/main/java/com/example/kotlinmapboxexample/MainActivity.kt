...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener, MapboxMap.OnMapClickListener {
    ...
    override fun onMapClick(point: LatLng): Boolean {
        ...
        Log.d("Origin LAT", locationComponent!!.lastKnownLocation!!.longitude.toString());
        Log.d("Origin LONG", locationComponent!!.lastKnownLocation!!.latitude.toString());
        Log.d("Origin Data2", originPoint.coordinates().toString());
        Log.d("DESTINATION DATA", point.longitude.toString()+ point.latitude.toString());
